  ...
  if (showPreview) {
    return (
      <div className="form-container">
        <h3 className="hi">Preview Section</h3>
        <ul className="h2">
          <li>
            <strong>PI/Researcher:</strong> {name_of_pi_research}
          </li>
          <li>
            <strong>PI Date:</strong> {date_pi}
          </li>
          <li>
            <strong>Co-PI/Guide:</strong> {name_of_co_pi_guide}
          </li>
          <li>
            <strong>Co-PI Date:</strong> {date_co_pi}
          </li>
          <li>
            <strong>Co-Investigator 1:</strong> {name_of_co_investigator_1}
          </li>
          <li>
            <strong>Co-Investigator 1 Date:</strong> {date_co_inv_1}
          </li>
          <li>
            <strong>Co-Investigator 2:</strong> {name_of_co_investigator_2}
          </li>
          <li>
            <strong>Co-Investigator 2 Date:</strong> {date_co_inv_2}
          </li>
          <li>
        ...
        <button onClick={() => setShowPreview(false)} className="name">
        Edit
        </button>
