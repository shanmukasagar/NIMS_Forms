...
const formFields = [
  ...
  { name: 'name', label: 'Name of Principal Investigator:', type: 'text' },
  {
    ...
    type: 'select',
    options: ['Deviation', 'Waiver', 'Violation', 'Non compliance']
  },
  ...
  { name: 'action_taken', label: 'Action taken by PI / Co-PI / Guide: (Not applicable in case of Waiver)', type: 'textarea' },
  ...
  { name: 'investigator_confirm_name', label: 'Name of Principal Investigator:', type: 'text' },
  { name: 'investigator_signature', label: 'Signature of Principal Investigator:', type: 'file' },
