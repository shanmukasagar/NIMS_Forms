    ...
    <html>
      ...
      <body>
       ...
       <div className="section">
          <div><span className="label">Name:</span> {data.administration.name_of_research_principal}</div>
          ...
          <div><span className="label">Review Type:</span> {data.administration.review_requested}</div>
          ...
          {/* selected_elements displayed one by one */}
        ...
        ${data.researchers.map(res => res.name ? `
          <div class="section">
            <div><span class="label">Type:</span> ${res.type || res.role || res.investigator_type}</div>
            ...
            <div><span class="label">Email:</span> ${res.gmail || res.email}</div>
        ...
        <div class="section">
          <div><span class="label">Estimated Budget:</span> ${data.fundingData.total_estimated_budget}</div>
